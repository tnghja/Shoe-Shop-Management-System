...
<div class="main_wrapper d-flex flex-row">
    ...
    <div class="sidenav text-wrap p-0 m-0">
        <nav class="nav nav-pills flex-column text-center p-0 m-0">
            <a class="nav-link px-3 py-3 px-0 my-2 rounded-4" aria-current="page" href="#">Dashboard</a>
            ...
            <a class="nav-link px-3 py-3 px-0 my-2 rounded-4 active" href="../app/index.php?page=manage">Quản lý đơn hàng</a>
        </nav>
    </div>
                    ...
                    <?php foreach ($orders as $order) : ?>
                        <tr>
                            ...
                            <td class="d-flex gap-1">
                                <button type="button" class="btn btn-success w-100 process w-25" data-order-id="<?= $order['id'] ?>">
                                    XỬ LÝ
                                </button>
                                <button type="button" class="btn btn-warning w-100 accept w-25" data-order-id="<?= $order['id'] ?>">
                                    XÁC NHẬN ĐANG GIAO
                                </button>
                                <button type="button" class="btn btn-primary w-100 confirm detail-order w-25" data-order-id="<?= $order['id'] ?>">
                                    XÁC NHẬN ĐÃ GIAO
                                </button>
                            </td>
                        </tr>
