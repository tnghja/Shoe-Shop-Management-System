        ...
        <div class="main_wrapper d-flex flex-row">
            ...
            <div class="productlist_main mx-0 px-0 container-fluid">
                ...
                <div class="productlist_content_header">
                    ...
                    <div
                        class="filter_header_one p-2 mx-0 d-flex flex-row flex-wrap justify-content-between align-content-center">
                        ...
                        table-sm mb-0">
                            ...
                            <tbody class="producttable__body">
                                <tr class="table__row" id="table_element_first">
                                    ...
                                    <td class="productoperator" class="btn-group btn-group-sm p-0 m-0"
                                        role="button group" aria-label="operator button group">
                                        <a href="/manage-index-view-info-product.html"
                                            type="button" class="checkproduct btn btn-sm btn-outline-secondary">
                                            XEM
                                        </a>
                                        <a href="/manage-index-update-product.html"
                                            type="button" class="update_info_product btn btn-sm btn-outline-secondary">
                                            SỬA
                                        </a>
