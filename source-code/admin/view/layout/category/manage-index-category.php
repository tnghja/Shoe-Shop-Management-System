...
<div class="main_wrapper d-flex flex-row">
    ...
    <div class="sidenav text-wrap p-0 m-0">
        ...
        <nav class="nav nav-pills flex-column text-center p-0 m-0">
            ...
            <a class="nav-link px-3 py-3 px-0 my-2 rounded-4 active" href="../app/index.php?page=category">Danh mục sản
                phẩm</a>
            <a class="nav-link px-3 py-3 px-0 my-2 rounded-4" href="../app/index.php?page=product-list">Danh sách
                sản phẩm</a>
            <a class="nav-link px-3 py-3 px-0 my-2 rounded-4 " aria-current="page" href="../app/index.php?page=add-product">Thêm sản phẩm</a>
